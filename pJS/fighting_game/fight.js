...
let player1=new Player('Janu',100,10)
let player2=new Player('Likky',100,10)
...
document.addEventListener("keydown",function(e){
    //if you press key Q and the enemy health is gtr than 0 and isover is still falsethen strike()
